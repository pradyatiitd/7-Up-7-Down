...
HD_PWD='/home/ansh/final_miniproject/final_miniproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_upSeven_down.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Seven_upSeven_down.tcl
